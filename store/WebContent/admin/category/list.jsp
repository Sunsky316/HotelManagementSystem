...
<HTML>
	<HEAD>
		...
		<script type="text/javascript">
			function addCity(){
				window.location.href = "${pageContext.request.contextPath}/AdminCityServlet?method=addCityUI";
			}
		</script>
	</HEAD>
	<body>
				...
				<TBODY>
					<tr>
						<td class="ta_01" align="center" bgColor="#afd1f3">
							<strong>城市分类列表</strong>
						</TD>
					</tr>
					<tr>
						<td class="ta_01" align="right">
							<button type="button" id="add" name="add" value="添加" class="button_add" onclick="addCity()">&#28155;&#21152;</button>
						</td>
					</tr>
					<tr>
