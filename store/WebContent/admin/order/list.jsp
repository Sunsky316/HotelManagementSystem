								...
								<c:forEach items="${allOrders}" var="o" varStatus="status">
										<tr onmouseover="this.style.backgroundColor = 'white'"
											...
											<td style="CURSOR: hand; HEIGHT: 22px" align="center"
												...
												<c:if test="${o.state==2}">
													<a href="/store/AdminOrderServlet?method=updateOrderByOid&oid=${o.oid}">已付款，未入住</a>
												</c:if>
												<c:if test="${o.state==3}">已入住</c:if>
											...
											<td align="center" style="HEIGHT: 22px" width="60%">
												...
												<table border="1" width="100%">
												   <!-- 
												   <tr><th>商品</th><th>名称</th><th>单价</th><th>天数</th></tr>
	...
	$(".myClass").click(function(){
		...
		if(txt=="订单详情"){
			...
			$.post(url,obj,function(data){
				...
				//清除内容
				$tb.html("");
				var th="<tr><th>房间</th><th>名称</th><th>单价</th><th>天数</th></tr>";
				$tb.append(th);
