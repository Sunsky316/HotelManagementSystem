...
<div class="dtree">
	...
	<script type="text/javascript">
	  <!--   
		...
		d.add('010201','0102','城市分类管理','${pageContext.request.contextPath}/AdminCityServlet?method=findAllCats','','mainFrame');
		
		d.add('0104','01','房间管理');
		d.add('010401','0104','房间管理','${pageContext.request.contextPath}/AdminProductServlet?method=findAllProductsWithPage&num=1','提示信息','mainFrame');
		d.add('010402','0104','已下架房间管理','${pageContext.request.contextPath}/admin/product/pushDown_list.jsp','','mainFrame');
		...
		d.add('010504','0105','已入住的订单','${pageContext.request.contextPath}/AdminOrderServlet?method=findOrders&state=3','','mainFrame');
