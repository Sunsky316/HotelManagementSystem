		 ...
		 <form id="orderForm" method="post" action="${pageContext.request.contextPath}/OrderServlet?method=payOrder">
			<div class="row">
				...
				<div style="text-align:right;margin-right:120px;">
					房间金额: <strong style="color:#ff6600;">￥${order.total}元</strong>
				</div>
			...
			<div>
				<hr/>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" name="address" class="form-control" id="username" placeholder="请输入用户备注">
						</div>
					</div>
					<div class="form-group">
						<label for="inputPassword3" class="col-sm-1 control-label">入住人</label>
						<div class="col-sm-5">
							<input type="text" name="name" class="form-control" id="inputPassword3" placeholder="请输入住人">
						</div>
					</div>
					<div class="form-group">
