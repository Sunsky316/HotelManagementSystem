			...
			<div class="row">
				...
				<div style="margin:0 auto;width:950px;">
				  ...
				  <form id="myForm" method="post" action="${pageContext.request.contextPath}/CartServlet?method=addCartItemToCart">
					...
					<div class="col-md-6">
					<!--
						${product}   :底层依此调用4个域对象上的*.getAttribute("keyName");
						寻找到request可以找到一个对象product
					 ...
					 -->
						...
						<div style="margin:10px 0 10px 0;">昊昊预订价: <strong style="color:#ef0101;">￥：${product.shop_price}元/天</strong> 市场价： <del>￥：${product.market_price}元/天</del>
						</div>
						...
						<div style="padding:10px;border:1px solid #e7dbb1;width:330px;margin:15px 0 10px 0;;background-color: #fffee6;">
							...
							<div style="border-bottom: 1px solid #faeac7;margin-top:20px;padding-left: 10px;">预订天数:
